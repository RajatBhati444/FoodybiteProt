...
//             // SnackbarHandler.errorToast(`${label} is required`);
...
//             // SnackbarHandler.errorToast(`${label} is invalid`);
//             validationStatus = false;
//             return false;
//           }
//           break;
...
//           if (form.password !== form[keyName]) {
//             // SnackbarHandler.errorToast(`Password mismatch`);
//             validationStatus = false;
//             return false;
//           }
//           break;
